    ...
    if st.session_state['buscar'] == True:
        ...
        if not df_eines.empty: 
            ...
            if not df_energia.empty:
                ...
                df_energia_de_eines = run_query(query)
        ...
        with st.sidebar:
            ...
            st.write("En cas de que hi hagin resultats, aquí els pots descarregar:")
